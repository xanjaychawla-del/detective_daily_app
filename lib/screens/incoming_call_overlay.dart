...
String _pickInspectorName(String caseId) => _kInspectorNames[caseId.hashCode.abs() % _kInspectorNames.length];
...
/// via on-device text-to-speech (never the network -- this has to work
/// offline and instantly, unlike the AI-narrated interview dialogue).
